        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              component: () => import('@/view/pages/vue-bootstrap/FormCheckbox.vue'),
            },
            {
              path: 'form-file',
            ...
            },
            {
              ...
              component: () => import('@/view/pages/vue-bootstrap/FormGroup.vue'),
            },
            {
              path: 'form-input',
              name: 'vue-bootstrap-form-input',
              component: () => import('@/view/pages/vue-bootstrap/FormInput.vue'),
            },
            {
              path: 'form-radio',
              name: 'vue-bootstrap-form-radio',
              component: () => import('@/view/pages/vue-bootstrap/FormRadio.vue'),
            },
            {
              path: 'form-select',
              name: 'vue-bootstrap-form-select',
              component: () => import('@/view/pages/vue-bootstrap/FormSelect.vue'),
            },
            {
              path: 'form-textarea',
              name: 'vue-bootstrap-form-textarea',
              component: () => import('@/view/pages/vue-bootstrap/FormTextarea.vue'),
            },
            {
              path: 'image',
            ...
            },
            {
              ...
              component: () => import('@/view/pages/vue-bootstrap/InputGroup.vue'),
            },
            {
              path: 'jumbotron',
              name: 'vue-bootstrap-jumbotron',
              component: () => import('@/view/pages/vue-bootstrap/Jumbotron.vue'),
            },
            {
              path: 'layout-grid-system',
              name: 'vue-bootstrap-layout-grid-system',
              component: () => import('@/view/pages/vue-bootstrap/LayoutGridSystem.vue'),
            },
            {
              path: 'link',
            ...
            },
            {
              ...
              component: () => import('@/view/pages/vue-bootstrap/ListGroup.vue'),
            },
            {
              path: 'media',
            ...
            },
            {
              ...
              component: () => import('@/view/pages/vue-bootstrap/Pagination.vue'),
            },
            {
              path: 'pagination-nav',
              name: 'vue-bootstrap-pagination-nav',
              component: () => import('@/view/pages/vue-bootstrap/PaginationNav.vue'),
            },
            {
              path: 'popover',
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              component: () => import('@/view/pages/vuetify/forms/Autocompletes.vue'),
            },
            {
              path: 'file-inputs',
              name: 'vuetify-file-inputs',
              component: () => import('@/view/pages/vuetify/forms/FileInputs.vue'),
            },
            {
              path: 'forms',
              name: 'vuetify-forms',
            ...
            },
            {
              ...
              component: () => import('@/view/pages/vuetify/forms/SelectionControls.vue'),
            },
            {
              path: 'selects',
            ...
            },
            {
              ...
              component: () => import('@/view/pages/vuetify/forms/Textareas.vue'),
            },
            {
              path: 'text-fields',
              name: 'vuetify-text-fields',
              component: () => import('@/view/pages/vuetify/forms/TextFields.vue'),
            },
            {
              path: 'simple-tables',
              name: 'vuetify-simple-tables',
              component: () => import('@/view/pages/vuetify/tables/SimpleTables.vue'),
            },
            {
              path: 'data-tables',
              name: 'vuetify-data-tables',
              component: () => import('@/view/pages/vuetify/tables/DataTables.vue'),
            },
            {
              path: 'tabs',
              name: 'vuetify-tabs',
