                  ...
                  <div class="font-weight-bold mb-3 mt-3 pl-2 pb-2">Join Member</div>
                    <form class="form-horizontal was-validated" method="post" action="<%=root%>/user/register">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input name ="userId" type="text" class="form-control" placeholder="" id="Id" required>
                          </div>
                        </div>
                        <div class="form-group row">
                          <label class="col-sm-3 text-md-right" for="Id">비밀번호<span class="text-danger small">*</span></label>
                          <div class="col-sm-8">
                            <input name ="userPwd" type="text" class="form-control" placeholder="영문 숫자 포함 6자리 이상" id="Id" required>
                          </div>
                        </div>
                        <div class="form-group row">
                          <label class="col-sm-3 text-md-right" for="Id">이름<span class="text-danger small">*</span></label>
                          <div class="col-sm-8">
                            <input name ="userName" type="text" class="form-control" placeholder="User Name" id="Id" required>
                          </div>
                        </div>
                        <div class="form-group row">
                          <label class="col-sm-3 text-md-right" for="Id">주소<span class="text-danger small">*</span></label>
                          <div class="col-sm-8">
                            <input name ="userAddress" type="text" class="form-control" placeholder="address" id="Id" required>
                          </div>
                        </div>
                        <div class="form-group row">
                          <label class="col-sm-3 text-md-right" for="Id">전화번호<span class="text-danger small">*</span></label>
                          <div class="col-sm-8">
                            <input name ="userPhone" type="text" class="form-control" placeholder="010-xxxx-xxxx" id="Id" required>
                          </div>
                        </div>
