    ...
    <head>
        ...
        $(document).ready(function () {
          ...
          $.each(data, function(index, item){
            ...
            studentlist += `<div class="media margin-clear">
                    <div class="media-body">
                    		<h4><a href='javascript:moveMap(37.6496953,127.027271,17);'>${item.city}</a></h4>
                      <h6 class="media-heading"  id='deal'>거래금액 :     ${item.num}만원</h6>
                      <h6 class="media-heading"  id='deal'>면적: ${item.munjuc}</h6>
                      <p class="small margin-clear">
                        <i class="fa fa-calendar pr-10"></i></i>${item.year}.${item.momth}.${item.day} </p>
                    </div>
                  </div>
                  <hr>
            `;
            $("#sell_list").empty().append(studentlist);
          });
